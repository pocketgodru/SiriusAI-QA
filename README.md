...
- ***detect.pdf*** - Демонстрация работы нашей основной программы. Она выделяет область интереса и считает количество людей **в** и **вне** очереди с помощью обученой нами модели YOLOv8m.
