...
6. **Создание алгоритма для второй системы**: 
...
Из них 64 тысячи изображений составили обучающий набор, а 3 тысячи - валидационный.

Извлеченные данные были преобразованы в формат, совместимый с архитектурой YOLO с помощью API Ultralytics и были вырезанны все классы кроме "person".
...
## Обучение модели
Обучение модели проводилось в течение 65 эпох. К концу обучения были достигнуты следующие результаты на валидационном датасете:
