...
- #### ***detect.pdf / detect.ipynb*** - Демонстрация работы нашей основной программы. Она выделяет область интереса и считает количество людей **в** и **вне** очереди с помощью обученой нами модели YOLOv8n.

- #### ***train.pdf / train.ipynb*** - Процесс обучения нашей модели. Рассмотрены следующие этапы - подготовка к обучению, само обучение и результаты.

- #### ***results.png*** - Результаты обучения нашей модели на графиках.

- #### ***best.pt*** - Обученная нами модель для обнаружения людей
...
Далее, используя обученную модель нейронной сети, ведется обнаружение людей и их подсчет на видеопотоке
